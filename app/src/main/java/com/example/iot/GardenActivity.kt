...
class GardenActivity : AppCompatActivity() {
    ...
    lateinit var detail: Gardent1Detail
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detail = Gardent1Detail()
        preference = MyPreference().getInstance(this)!!
        binding = DataBindingUtil.setContentView(this, R.layout.activity_garden)

        binding.tvSettime1.text = preference.getTextTime("g1_text1")
        binding.edtTemp1.setText(preference.getTextTemp("g1_temp1"))
        binding.edtHumi1.setText(preference.getTextHumi("g1_humi1"))

        binding.tvSettime2.text = preference.getTextTime("g1_text2")
        binding.edtTemp2.setText(preference.getTextTemp("g1_temp2"))
        binding.edtHumi2.setText(preference.getTextHumi("g1_humi2"))

        binding.tvSettime3.text = preference.getTextTime("g1_text3")
        binding.edtTemp3.setText(preference.getTextTemp("g1_temp3"))
        binding.edtHumi3.setText(preference.getTextHumi("g1_humi3"))
...
//            binding.imvPumpOn.visibility=View.GONE
        ...
        binding.btnok1.setOnClickListener {
            if (binding.edtTemp1.text.toString().isNotBlank() && binding.edtTemp1.text.toString()
                ...
                if (binding.tvSettime1.text.isNotBlank()) {
                    ...
                    preference.saveTimeGarden("g1_t1", time_gone)
                    preference.saveTempGarden("g1_temp1", binding.edtTemp1.text.toString())
                    preference.saveTempGarden("g1_humi1", binding.edtHumi1.text.toString())
                    preference.setTextTime("g1_text1", binding.tvSettime1.text.toString())
        ...
        binding.btnok2.setOnClickListener {
            if (binding.edtTemp2.text.toString().isNotBlank() && binding.edtTemp2.text.toString()
                ...
                if (binding.tvSettime2.text.isNotBlank()) {
                    ...
                    WorkManager.getInstance(this).enqueue(myWorker)
                    preference.saveTimeGarden("g1_t2", time_gone)
                    preference.saveTempGarden("g1_temp2", binding.edtTemp2.text.toString())
                    preference.saveTempGarden("g1_humi2", binding.edtHumi2.text.toString())

                    preference.setTextTime("g1_text2", binding.tvSettime2.text.toString())
        ...
        binding.btnok3.setOnClickListener {
            if (binding.edtTemp3.text.toString().isNotBlank() && binding.edtTemp3.text.toString()
                ...
                if (binding.tvSettime3.text.isNotBlank()) {
                    ...
                    WorkManager.getInstance(this).enqueue(myWorker)
                    preference.saveTimeGarden("g1_t3", time_gone)
                    preference.saveTempGarden("g1_temp3", binding.edtTemp3.text.toString())
                    preference.saveTempGarden("g1_humi3", binding.edtHumi3.text.toString())
                    preference.setTextTime("g1_text3", binding.tvSettime3.text.toString())
        ...
        binding.tvNext.setOnClickListener {
            ...
            intent.putExtra("publish", "update1")
            ...
            mqttManager!!.subscribeToTopic(
                ...
                runOnUiThread {
                    try {
                        ...
                        detail = Gson().fromJson(message, Gardent1Detail::class.java)
                        try {
